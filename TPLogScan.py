...
def foundLogPath(url, version):
    log_path_list = {
        3: ['/Runtime/Logs/','/App/Runtime/Logs/','/Application/Runtime/Logs/','/Application/Runtime/Logs/Admin/', '/Application/Runtime/Logs/Home/'],
        5: '/runtime/log/',
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--month', type=int, default=1, help="datetime start month, default 1")
    ...
    dir_name = url.replace('https://', '').replace('http://', '').replace('/', '')
    data_path = 'TPLogData'
